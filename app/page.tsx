  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <div className="relative z-10 container mx-auto p-3 sm:p-4 pt-20 sm:pt-24 pb-6 sm:pb-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                    <AnimatedSection animation="slide-right" delay={100}>
                      <div className="space-y-3">
                        <h4 className="text-sm font-medium text-zinc-400">Programming Languages</h4>
                    ...
                    <AnimatedSection animation="slide-left" delay={200}>
                      <div className="space-y-3">
                        <h4 className="text-sm font-medium text-zinc-400">Frameworks & Libraries</h4>
                        <div className="flex flex-wrap gap-2">
                    ...
                    <AnimatedSection animation="slide-right" delay={300}>
                      <div className="space-y-3">
                        <h4 className="text-sm font-medium text-zinc-400">Database & Tools</h4>
                        <div className="flex flex-wrap gap-2">
                          {technicalSkills.databaseAndTools.map((skill, index) => (
                            <SkillTagComponent key={index}>{skill}</SkillTagComponent>
                          ))}
                        </div>
                      </div>
        ...
        >
          <p>© {new Date().getFullYear()} Rutuja Kolate. All rights reserved.</p>
        </AnimatedSection>
      </div>
