          ...
          <div className="bg-zinc-800/50 p-6 lg:p-8">
            ...
            <div className="space-y-6">
              <p className="text-zinc-300">
                Aspiring full-stack developer passionate about user-centered design, accessibility, and ethical tech. Experienced in building real-world web apps using Java, Spring Boot, and ReactJS through internships and freelance projects.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:rutujakolte193@gmail.com"
                      className="text-sm text-zinc-400 hover:text-cyan-400 transition-colors"
                    >
                      rutujakolte193@gmail.com
                    </a>
                  </div>
                </div>
